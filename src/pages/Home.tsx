    ...
    <>
      <section className="mb-8">
        ...
        <p className="text-lg leading-relaxed">
          My name is Chen Peleg and I am a passionate professional dedicated to excellence in my field.
      ...
      <section>
        ...
        <p className="text-lg leading-relaxed">
          Throughout my career, I, Chen Peleg, have worked on diverse projects that have honed my expertise and problem-solving abilities.
